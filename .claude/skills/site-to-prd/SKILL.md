...
6. Делает скриншот стартовой страницы (1280×800) как `desktop.png`
...
2. Запусти scraper командой:
   ...
   ```
3. Сообщи пользователю где сохранены `pages.json` и скриншот
4. Если нужно сгенерировать PRD — проанализируй pages.json и скриншоты, создай документ в папке `--output/prd.md`
